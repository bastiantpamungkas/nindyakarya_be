    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST_MYSQL', '0.tcp.ap.ngrok.io'),
            'port' => env('DB_PORT_BATIK', '19090'),
            'database' => env('DB_DATABASE_MYSQL', 'gtos'),
        ...
        'pgsql' => [
            ...
            'database' => env('DB_DATABASE', 'nindyakarya'),
        ...
        'pgsql_ngrok' => [
            ...
            'database' => env('DB_DATABASE_NGROK', 'nindyakarya'),
